<!-- c7fff3f2-03ed-485c-b025-9a6be789bf91 f75f1cb1-a994-4c6c-8b1a-c7ab57dbb9bd -->
...
- [ ] Проверить документацию GigaChat API на поддержку stop_sequences и других параметров остановки
- [ ] Модифицировать ChatWithJSON для приема и передачи истории сообщений в API
- [ ] Добавить загрузку истории сообщений из БД в ChatHandler перед отправкой в API
- [ ] Создать новый endpoint /api/chat/collect для режима автоматического сбора требований
- [ ] Реализовать генератор system prompt на основе списка обязательных вопросов
- [ ] Добавить парсинг JSON-ответов для определения статуса (collecting/ready)
- [ ] Реализовать автоматический цикл вопрос-ответ с остановкой при готовности
- [ ] Добавить UI для настройки обязательных вопросов и отображения процесса сбора